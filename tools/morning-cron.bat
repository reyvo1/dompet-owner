...
"C:\Users\IVO\AppData\Local\Microsoft\WinGet\Packages\PHP.PHP.8.4_Microsoft.Winget.Source_8wekyb3d8bbwe\php.exe" "C:\Users\IVO\dompet-owner\tools\reminder-cron.php" >> "C:\Users\IVO\dompet-owner\tools\reminder.log" 2>&1
